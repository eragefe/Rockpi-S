...
{
	switch (reg) {
	case ES9018K2M_VOLUME1:
        case ES9018K2M_VOLUME2:
	case ES9018K2M_GENERAL_SET:
		return true;
...
SOC_DOUBLE_R_TLV("Master Playback Volume", ES9018K2M_VOLUME1, ES9018K2M_VOLUME2, 0, 255, 1, volume_tlv),
